...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Jan-2019 às 17:31
...
INSERT INTO `carrinho` (`id_pro`, `end_ip`, `quant`) VALUES
(6, '::1', 3);
...
CREATE TABLE `clientes` (
  ...
  `cliente_cep` varchar(100) NOT NULL,
  `cliente_endereco` text NOT NULL,
  `cliente_complemento` text NOT NULL,
  `cliente_telefone` varchar(255) NOT NULL,
  `cliente_cpf` varchar(255) NOT NULL,
  `cliente_sexo` varchar(100) NOT NULL,
  `cliente_idade` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `clientes` (`cliente_id`, `cliente_ip`, `cliente_nome`, `cliente_sobrenome`, `cliente_email`, `cliente_senha`, `cliente_pais`, `cliente_cidade`, `cliente_cep`, `cliente_endereco`, `cliente_complemento`, `cliente_telefone`, `cliente_cpf`, `cliente_sexo`, `cliente_idade`) VALUES
(1, '::1', 'Pedro', 'Cardoso Todorovski', 'pedroc.todorovskibr@gmail.com', 'amigo', 'Brazil', 'Lins', '16400-460', 'Rua JosÃ© Garcia de Carvalho nÂº300', 'Apto. 31 B', '19 999547609', '4044533910', 'Maculino', 19),
(3, '::1', 'JoÃ£o', 'Cardoso Todorovski', 'joaoc.todorovskibr@gmail.com', 'teste', 'Brazil', 'Campinas', '16120543', 'Rua Teste aqui', 'Casa azul', '19 999999999', '4134234234', 'Maculino', 19);
...
INSERT INTO `produtos` (`produto_id`, `produto_nome`, `produto_marca`, `produto_cat`, `produto_subcateg`, `produto_tipo`, `produto_preco`, `produto_desc`, `produto_keywords`, `produto_img`, `code`, `armazem_id`, `quantidade`) VALUES
(1, 'Leite Paulista 1L', '3', 1, 1, 1, 2.50, 'Leite Paulista 1 Litro  - Conservante', 'leite, bebidas, paulista', 'leite-paulista-1l.jpg', 'LTEPLST1L', NULL, 5),
(2, 'Coca Cola 1L', '1', 1, 4, 2, 2.85, 'Coca Cola 1 Litro - Contém glúten', 'Coca Cola, refrigerante, bebida', 'coca-cola-1l.jpg', 'CCLA1L', NULL, 10),
(3, 'Arroz Branco Longo-fino Tipo 1 Tio João 5Kg', '5', 1, 2, 3, 11.00, 'Arroz tipo fino', 'arroz, grãos, tio joao', 'arroz-tio-joao-5kg.jpg', 'ARR5KGTJO', NULL, 100),
(5, 'Feijão Preto Tipo 1 Urbano 1Kg', '7', 1, 2, 3, 3.99, 'O feijão preto Urbano é o mais gostoso que existe! é tão bom que lembra a feijoada da vovó... Compre já e delicie-se.', 'feijão, grãos, mercado', 'feijao-preto-urbano-alimentos.png', 'FJOTJO1KG', NULL, 50),
(6, 'Nescau 400g', '8', 1, 1, 5, 5.99, 'É gostoso pra caramba!', 'nescau, achocolatado, nestle, matinais', 'nescau-nestle.jpg', 'NESCAU400G', NULL, 20),
(7, 'Chocolate Hersheys', '9', 1, 2, 6, 4.00, 'Muito gostoso', 'chocolate', 'chocolate-barra-hersheys.jpg', 'CHOCHRSH500G', NULL, 20),
(8, 'Cerveja Império Long Neck 350ml', '6', 1, 4, 4, 2.25, 'A cerveja que tem gosto de história', 'cerveja, imperio, bebidas', 'cerveja-imperio-350ml.jpg', 'CVJIMP350ML', NULL, 20),
(9, 'Suco de Laranja Del Valle 100% Natural 1L', '10', 1, 4, 7, 4.00, 'Este suco é 100% feito com laranja especialmente selecionadas', 'suco, laranja, suco de laranja, del valle, bebidas', 'Suco-Del-Valle-100--Suco-de-Laranja-1l.jpg', 'SCLAR1LDLLVL', NULL, 100),
(10, 'Panettone Bauducco 500g', '11', 1, 9, 8, 25.00, 'O natal chegou, e com ele vieram as gostosuras da bauducco!', 'panettone, natal, bauducco', 'PANETONE-BAUDUCCO-500G-FRUTAS.jpg', 'PTONNE500GBDCO', NULL, 40),
(11, 'Chocottone Bauducco 500g', '11', 1, 9, 9, 13.00, 'O chocottone mais delicioso já chegou para as festividades de final de ano!', 'chocottone, bauducco, natal', 'chocotone-bauducco-gotas-de-chocolate-500-g_600x600-PU6c8dc_1.jpg', 'CTONNE500GBAU', NULL, 50);
...
--
ALTER TABLE `carrinho`
  MODIFY `id_pro` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `clientes`
  MODIFY `cliente_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
