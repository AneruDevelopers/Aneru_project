...
<body>
<div class="l-wrapper_subcategorias">
        <div class='l-header-top_subcategorias'>
        ...
        <div class="l-header-bottom_subcategorias" id="headerSticky">
        ...
        <div class="l-main_subcategorias">
    <?php
    ...
    ?>
        ...
        <div class="l-footer_subcategorias">
