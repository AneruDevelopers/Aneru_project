...
--
-- Host: localhost:3306
-- Tempo de geração: 14/01/2019 às 14:02
...
--
-- Banco de dados: `marke655_marketviser`
--
...
--
-- Fazendo dump de dados para tabela `armazem`
--
...
(1, 'Leite Paulista 1L', '3', 1, 1, 1, 2.50, 'Leite Paulista 1 Litro  - Conservante', 'leite, bebidas, paulista', 'leite-paulista-1l.jpg', 'LTEPLST1L', 3, 5, 0),
(2, 'Coca Cola 1L', '1', 1, 4, 2, 2.85, 'Coca Cola 1 Litro - Contém glúten', 'Coca Cola, refrigerante, bebida', 'coca-cola-1l.jpg', 'CCLA1L', 3, 99, 100),
(3, 'Arroz Branco Longo-fino Tipo 1 Tio João 5Kg', '5', 1, 2, 3, 11.00, 'Arroz tipo fino', 'arroz, grãos, tio joao', 'arroz-tio-joao-5kg.jpg', 'ARR5KGTJO', 3, 0, 100),
(5, 'Feijão Preto Tipo 1 Urbano 1Kg', '7', 1, 2, 3, 3.99, 'O feijão preto Urbano é o mais gostoso que existe! é tão bom que lembra a feijoada da vovó... Compre já e delicie-se.', 'feijão, grãos, mercado', 'feijao-preto-urbano-alimentos.png', 'FJOTJO1KG', 3, 0, 0),
(6, 'Nescau 400g', '8', 1, 1, 5, 5.99, 'É gostoso pra caramba!', 'nescau, achocolatado, nestle, matinais', 'nescau-nestle.jpg', 'NESCAU400G', 3, 0, 0),
(7, 'Chocolate Hersheys', '9', 1, 2, 6, 4.00, 'Muito gostoso', 'chocolate', 'chocolate-barra-hersheys.jpg', 'CHOCHRSH500G', 3, 20, 0),
(8, 'Cerveja Império Long Neck 350ml', '6', 1, 4, 4, 2.25, 'A cerveja que tem gosto de história', 'cerveja, imperio, bebidas', 'cerveja-imperio-350ml.jpg', 'CVJIMP350ML', 3, 0, 0),
(9, 'Suco de Laranja Del Valle 100% Natural 1L', '10', 1, 4, 7, 4.00, 'Este suco é 100% feito com laranja especialmente selecionadas', 'suco, laranja, suco de laranja, del valle, bebidas', 'Suco-Del-Valle-100--Suco-de-Laranja-1l.jpg', 'SCLAR1LDLLVL', 3, 83, 0),
(10, 'Panettone Bauducco 500g', '11', 1, 9, 8, 25.00, 'O natal chegou, e com ele vieram as gostosuras da bauducco!', 'panettone, natal, bauducco', 'PANETONE-BAUDUCCO-500G-FRUTAS.jpg', 'PTONNE500GBDCO', 3, 40, 0),
(11, 'Chocottone Bauducco 500g', '11', 1, 9, 9, 13.00, 'O chocottone mais delicioso já chegou para as festividades de final de ano!', 'chocottone, bauducco, natal', 'chocotone-bauducco-gotas-de-chocolate-500-g_600x600-PU6c8dc_1.jpg', 'CTONNE500GBAU', 3, 50, 0);
...
--
-- Fazendo dump de dados para tabela `subcateg`
--
...
--
-- Estrutura para tabela `tipoprod`
--
...
--
-- Fazendo dump de dados para tabela `tipoprod`
--
...
--
-- Restrições para tabelas `tipoprod`
--
ALTER TABLE `tipoprod`
